...
export const ui = {
  el: {
    ...
    'clients.title': 'Εμπιστοσύνη από το δημόσιο και τον ιδιωτικό τομέα',
    'clients.lead': 'Έργα από το 2001 για το δημόσιο και τον ιδιωτικό τομέα σε όλη τη χώρα, ομαδοποιημένα ανά πεδίο αντικειμένου και τύπο φορέα, όχι ως αναλυτικός κατάλογος.',
    ...
    'page.erga.intro': 'Έργα από το 2001 για το δημόσιο και τον ιδιωτικό τομέα σε όλη τη χώρα, ομαδοποιημένα ανά πεδίο αντικειμένου και τύπο φορέα.',
    'page.nea.title': 'Νέα',
    ...
    'con.legal.v': 'INNOLAND Ε.Π.Ε. (Καινοτόμα Επιχειρηματικά Δίκτυα Ανάπτυξης). Μέλος Ε.Β.Ε.Α. και Γ.Ε.ΜΗ., Αριθμός Γ.Ε.ΜΗ.: 004559501000',
